// Auto-extracted from dav1d 1.4.1 cdf.c (qcat 0). Inverse-cdf form, trailing 0.

pub static KF_Y_DC: [u16; 13] = [
    17180, 15741, 13430, 12550, 12086, 11658, 10943, 9524, 8579, 4603, 3675, 2302, 0,
];

pub static UV_DC: [u16; 13] = [
    10137, 8616, 7390, 7107, 6782, 6248, 5713, 4845, 4524, 2709, 1827, 807, 0,
];

pub static PART_64: [u16; 10] = [12631, 11221, 9690, 3202, 2931, 2507, 2244, 1876, 1044, 0];

pub static BLK_SKIP: [u16; 2] = [1097, 0];

pub static C_SKIP: [[u16; 2]; 13] = [
    [919, 0],
    [26876, 0],
    [20656, 0],
    [10833, 0],
...
pub static EOB_BIN16: [[u16; 5]; 2] = [
    [31928, 31729, 30788, 27873, 0],
    [29521, 27818, 23080, 18205, 0],
];

pub static EOB_HI: [[[u16; 2]; 11]; 2] = [
    [
        [16384, 0],
        [16384, 0],
        [15807, 0],
...
pub static BASE_TOK: [[[u16; 4]; 41]; 2] = [
    [
        [28734, 23838, 20041, 0],
        [14686, 3027, 891, 0],
        [20172, 6644, 2275, 0],
...
pub static PART_SPLIT_64: [[u16; 10]; 4] = [
...
pub static PART_SPLIT_32: [[u16; 10]; 4] = [
...
pub static PART_SPLIT_16: [[u16; 10]; 4] = [
