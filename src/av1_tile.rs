//! Real AV1 lossless tile encoder for a 64×64 4:4:4 still image.
//! Mirrors dav1d decode_b / recon_b_intra for TX_4X4 / WHT_WHT / DC_PRED.
//! All symbols emitted against fixed default CDFs (disable_cdf_update=1).
