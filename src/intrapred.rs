//! AV1 intra prediction: mode constants, CfL helpers, the non-directional /
//! directional predictor (`intra_predict_nd`), and the per-size `dc_pred_*`
//! DC predictors. Extracted from `av1real`.
